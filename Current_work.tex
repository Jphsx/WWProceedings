...
\begin{tikzpicture}
    ...
    {
        \includegraphics[width=0.1\textwidth]{ildlogo.png}
    };
    \end{tikzpicture}
...
\begin{figure}
 ...
 %   \begin{minipage}{0.49\textwidth}
   ...
   \node(a){\includegraphics[scale=.6]{SupDiff.pdf}};
    \node at (a.north west)
    [
    anchor=center,
    xshift= 2.5cm,
    ...
    {
        \includegraphics[width=0.05\textwidth]{ildlogo.png}
    };
    \end{tikzpicture}
   ...
   \begin{figure}
    ...
    \node(a){\includegraphics[scale=.6]{SupMass.pdf}};
    \node at (a.north west)
    [
    anchor=center,
    xshift= 2.5cm,
...
\label{tab:selection}
 ...
 Tight selection with muon cone \\
   \begin{tabular}{|p{0.11\textwidth}|p{0.08\textwidth}p{0.08\textwidth}p{0.08\textwidth}|p{0.08\textwidth}|p{0.08\textwidth}p{0.08\textwidth}p{0.08\textwidth}p{0.1\textwidth}|p{0.1\textwidth}|}
\hline 
...
\hline 
 ...
 $\epsilon \, \, (\%)$ & $69.4 $ & $65.4 $ & $46.2$ &  $60.3 $ & $0.69 $ & $0.626 $ & $9.05 $ & $5.41 $ & $0.72$ \\ 
 			...
 			& $\pm$0.2 & $\pm$0.2 & $\pm$0.3 & $\pm$0.2 & $\pm$ 0.01 & $\pm$ 0.008 & $\pm$ 0.02 & $\pm$0.05  & $\pm$0.01\\
\hline
\end{tabular}
\quad \quad \\
...
\hline 
 $\epsilon \, \, (\%)$ & $1.02 $ & $1.98 $ & $10.5 $ &  $4.49 $ & $0.241 $ & $0.236 $ & $0.474 $ & $2.36 $ & $0.251$\\ 
  	     ...
  	     & $\pm 0.5$ & $\pm 0.07$ & $\pm 0.2$ & $\pm 0.07$ & $\pm 0.003$ & $\pm 0.004$ & $\pm 0.007$ & $\pm 0.02$ & $\pm 0.003$ \\
...
\begin{table}
\centering
\caption{The tight and loose selection for 1600 fb −1 (-0.8,+0.3) non WW-like or off-shell (O.S.) events.  The Base
...
$E_com$ &{3.44 } & {18.1 } & {2.39} & 23.9\\ 
 
Pt vis. &{3.40 } & {18.0 } & {2.36} & 23.8\\ 
 
$(m^{\text{vis}}_{\text{recoil}})^2$ & {3.40 } & {17.6 } & {2.34}& 23.3\\ 
\hline 
 $\epsilon \, \, (\%)$ & $58.8 \pm 0.6$ & $45.4 \pm 0.1$ & $41.1 \pm 0.6$ & $46.3 \pm 0.1$ \\ 
 \hline
\end{tabular}
%\end{table}
\end{minipage}
...
Tight Veto &{0.0818 } & {2.61 } & {0.883} & 3.57\\ 

$E_{vis}$ &{0.0787 } & {2.61 } & {0.883} & 3.57\\ 

N Tracks &{0.0757 } & {2.48 } & {0.863} & 3.42\\ 

$-q\cos\theta$ &{0.0697 } & {2.31 } & {0.815} & 3.20\\ 
 
$M_{qq} > 40$ &{0.0560 } & {1.38 } & {0.766} & 2.20\\ 

$M_{qq} < 120$ &{0.0363 } & {1.20 } & {0.482} & 2.05\\ 
 
$E_{com}$ &{0.363 } & {1.18 } & {0.482} & 2.03\\ 
 
Pt vis. &{0.363 } & {1.18 } & {0.477 }& 2.02\\ 

$(m^{\text{vis}}_{\text{recoil}})^2$ &{0.0363 } & {0.915 } & {0.473} & 1.42\\ 
\hline 
 $\epsilon$ & $0.63 \pm 0.1$ & $2.36 \pm 0.05$ & $8.3 \pm 0.4$ & $2.82 \pm 0.05$\\ 
 \hline
 \end{tabular}
...
\label{tab:summary}
 \begin{tabular}{ |p{0.12\textwidth}|p{0.12\textwidth}p{0.15\textwidth}|p{0.10\textwidth}|p{0.12\textwidth}p{0.17\textwidth}|p{0.11\textwidth}|} 
 \hline 
